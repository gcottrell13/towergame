import ___assets__floors__basic_floor_bg_png from './assets/floors/basic-floor-bg.png';
import ___assets__floors__empty_floor_bg_png from './assets/floors/empty-floor-bg.png';
...
import ___assets__workers__faceless_walk_gif from './assets/workers/faceless-walk.gif';
export namespace floors {
    export const BASIC_FLOOR_BG_PNG = ___assets__floors__basic_floor_bg_png;
    export const EMPTY_FLOOR_BG_PNG = ___assets__floors__empty_floor_bg_png;
    export const ROOF1_PNG = ___assets__floors__roof1_png;
}
export namespace resources {
    export const COIN_PNG = ___assets__resources__coin_png;
}
...
export namespace transports {
    export const STAIRWELL1_PNG = ___assets__transports__stairwell1_png;
}
export namespace workers {
    export const FACELESS_WALK_GIF = ___assets__workers__faceless_walk_gif;
}
const all = {
    floors,
    resources,
